...
public class AutoTests_HW {
    public static void main(String[] args) {
        ...
        String nameOfEmail = driver.findElement(By.id(ID_EMAIL_NAME)).getAttribute("value") + EMAIL_DOMAIN; // 3.4
...
//       Assert.assertTrue(checkActive.contains("active"));
        ...
        String secretAddress = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id(ID_SECRET_ADDRESS))).getAttribute("textContent"); // 3.6
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(XPATH_CLOSE_SETTINGS_BUTTON))).click();
        ...
        driver.findElement(By.xpath(XPATH_LETTER_TO)).sendKeys(nameOfEmail);
        driver.findElement(By.xpath(XPATH_LETTER_THEME)).sendKeys("Test");
        driver.findElement(By.xpath(XPATH_LETTER_BODY)).sendKeys(secretAddress);
        ...
        String senderName = driver.findElement(By.xpath(XPATH_SENDER_EMAIL)).getAttribute("textContent");
        Assert.assertEquals(nameOfEmail, senderName);
        String themeOfEmail = driver.findElement(By.xpath(XPATH_THEME_INCOME_LETTER)).getAttribute("textContent");
        Assert.assertEquals("Test", themeOfEmail);
        String textOfEmail = driver.findElement(By.xpath(XPATH_BODY_INCOME_LETTER)).getAttribute("textContent");
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(XPATH_BACK_BUTTON)))  // 3.15
                .click();
        ...
        String toCheckRe = driver.findElement(By.xpath(XPATH_THEME_INCOME_LETTER_MAINPAGE)).getAttribute("textContent");
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(XPATH_CONFIRM_DELETE_LETTER_BUTTON)))
                .click();

        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(XPATH_DELETE_ALL))); // 3.19
